                ...
                <div class="row">
                    <div class="col-3">
                        <div class="mt-5">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <a href="{{ route('suratk.download', $suratk->berkas) }}">{{$suratk->berkas}} <i class="fa-solid fa-print"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-9">
                        <table class="table table-borderless">
                            <tr>
                                <td class="text-end col-md-4 fw-bold fs-5"># Detail Surat Keluar</td>
                                <td class="fs-5 col-md-8 fw-bold">{{$suratk->no}}</td>
                            </tr>
                            <tr>
                                <td class="text-end text-secondary">Tanggal surat</td>
                                <td><i class="fa-solid fa-calendar-days text-warning"></i> {{$suratk->tgl_surat}}</td>
                            </tr>
                            <tr>
                                <td class="text-end text-secondary">Jenis surat</td>
                                <td>{{$suratk->jenis_surat->name}}</td>
                            </tr>
                            <tr>
                                <td class="text-end text-secondary">Perihal</td>
                                <td>{{$suratk->perihal}}</td>
                            </tr>
                            <tr>
                                <td class="text-end text-secondary">Pengirim</td>
                                <td>{{$suratk->pengirim}}</td>
                            </tr>
                            <tr>
                                <td class="text-end text-secondary">Ditujukan</td>
                                <td>{{$suratk->ditujukan}}</td>
                            </tr>
                            <tr>
                                <td class="text-end text-secondary">Created by</td>
                                <td>{{$suratk->user->name}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
